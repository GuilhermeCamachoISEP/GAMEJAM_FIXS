...
const _VisionRingConstants = preload("res://scripts/visual/vision_ring_constants.gd")
...
func _process(_delta: float) -> void:
	...
	var near: bool = p != null and is_instance_valid(p) and global_position.distance_to(p.global_position) <= _VisionRingConstants.WORLD_RADIUS
